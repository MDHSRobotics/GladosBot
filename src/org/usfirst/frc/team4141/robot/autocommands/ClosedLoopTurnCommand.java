...
public class ClosedLoopTurnCommand extends MDCommand {
	...
	private double m_robotRotationalDiameter = 23.375; // In inches
	private double m_rotationalCircumference = (Math.PI)*(m_robotRotationalDiameter);
	private double m_rotateDistance; // In inches
	private double m_rotateDistanceRaw;
	private double m_wheelCircumferenceInches = 6;
	
	private int m_nativeUnitsPerRotation = 4096;
	...
	public ClosedLoopTurnCommand(MDRobotBase robot, String name, double targetAngle, double speed) {
		...
		System.out.println("Closed loop turn command has been constructed");
	...
	protected void initialize() {
		System.out.println("Closed looped turn initialized");
	...
	private void initEncoderTalon(WPI_TalonSRX talon){
		...
		talon.set(ControlMode.Position, m_rotateDistanceRaw);
	
		System.out.println("Target rotation in Degrees = " + m_targetAngle);
	}
	...
	protected void execute() {
		talonL.set(ControlMode.Position, m_rotateDistanceRaw);
		talonR.set(ControlMode.Position, -m_rotateDistanceRaw);
	}
