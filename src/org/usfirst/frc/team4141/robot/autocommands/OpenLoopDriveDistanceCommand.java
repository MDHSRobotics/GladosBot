...
public class OpenLoopDriveDistanceCommand extends MDCommand {
	 ...
	 */
	public OpenLoopDriveDistanceCommand(MDRobotBase robot, String name, double targetDistanceInFeet, double power) {
		super(robot, name);
